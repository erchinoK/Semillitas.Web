                ...
                c => new
                    {
                        ...
                        RenewalNumber = c.Int(nullable: false),
                        StartDate = c.DateTime(),
                        ExpirationDate = c.DateTime(),
                        ChildFirstName = c.String(),
                        ChildLastName = c.String(),
                        ChildBirthDate = c.DateTime(nullable: false),
                        HasSpecialNeed = c.Boolean(nullable: false),
                        SpecialNeedNotes = c.String(),
                        ChildNotes = c.String(),
                ...
                c => new
                    {
                        ...
                        IsRegistrationRequired = c.Boolean(nullable: false),
                        NumberPayments = c.Int(nullable: false),
                        PriceRegistration = c.Decimal(nullable: false, precision: 18, scale: 2),
                        PriceFee = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Duration = c.String(),
